        ...
        <button
          onClick={async () => {
            try {
              ...
              alert('İndirme başarısız oldu. Lütfen sayfayı yenileyip tekrar deneyin.');
            }
          }}
          className="p-2 bg-blue-700 hover:bg-blue-800 rounded flex items-center gap-2 cursor-pointer"
